...
const booleanKeysBySection = {
  ...
  seo: [
    "indexHomepage",
    "includeHomepageInSitemap",
    "indexStockPages",
    "includeStockPagesInSitemap",
    "indexMutualFundPages",
    "includeMutualFundPagesInSitemap",
    "indexWealthPages",
    "includeWealthPagesInSitemap",
    "indexNewsDetailPages",
    "includeNewsDetailPagesInSitemap",
    "indexNewsListingPage",
    "includeNewsListingPageInSitemap",
    "indexMarketsPages",
    "includeMarketsPagesInSitemap",
    "indexSearchPages",
    "includeSearchPagesInSitemap",
    "indexIndexPages",
    "includeIndexPagesInSitemap",
  ],
  experience: [],
